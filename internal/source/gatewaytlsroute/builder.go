...
// Builder creates external-dns Gateway TLSRoute sources.
type Builder struct {
	gatewayClient gateway.Interface
}

// NewBuilder creates a new Gateway TLSRoute source builder.
func NewBuilder() *Builder { return &Builder{} }

func (b *Builder) Type() registry.SourceType { return SourceTypeGatewayTLSRoute }

func (b *Builder) Enabled(cfg *config.OperatorConfig) bool {
	return cfg.Sources.GatewayTLSRoute != nil && cfg.Sources.GatewayTLSRoute.Enabled
}
