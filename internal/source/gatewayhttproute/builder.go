...
// Builder creates external-dns Gateway HTTPRoute sources.
type Builder struct {
	gatewayClient gateway.Interface
}

// NewBuilder creates a new Gateway HTTPRoute source builder.
func NewBuilder() *Builder { return &Builder{} }

func (b *Builder) Type() registry.SourceType { return SourceTypeGatewayHTTPRoute }

func (b *Builder) Enabled(cfg *config.OperatorConfig) bool {
	return cfg.Sources.GatewayHTTPRoute != nil && cfg.Sources.GatewayHTTPRoute.Enabled
}
