...
// Builder creates external-dns Gateway GRPCRoute sources.
type Builder struct {
	gatewayClient gateway.Interface
}

// NewBuilder creates a new Gateway GRPCRoute source builder.
func NewBuilder() *Builder { return &Builder{} }

func (b *Builder) Type() registry.SourceType { return SourceTypeGatewayGRPCRoute }

func (b *Builder) Enabled(cfg *config.OperatorConfig) bool {
	return cfg.Sources.GatewayGRPCRoute != nil && cfg.Sources.GatewayGRPCRoute.Enabled
}
