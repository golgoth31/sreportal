...
// SourceTypeGatewayTCPRoute identifies gateway.networking.k8s.io TCPRoute sources.
...
func (*Resolver) Type() registry.SourceType     { return SourceTypeGatewayTCPRoute }
func (*Resolver) ObjectList() client.ObjectList { return &gwapiv1alpha2.TCPRouteList{} }

func (*Resolver) ResolveObject(_ context.Context, obj client.Object) ([]*endpoint.Endpoint, error) {
	rt, ok := obj.(*gwapiv1alpha2.TCPRoute)
	if !ok {
		return nil, registry.UnexpectedObjectType(SourceTypeGatewayTCPRoute, obj)
	}
