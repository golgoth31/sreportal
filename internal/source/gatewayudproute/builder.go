...
// Builder creates external-dns Gateway UDPRoute sources.
type Builder struct {
	gatewayClient gateway.Interface
}

// NewBuilder creates a new Gateway UDPRoute source builder.
func NewBuilder() *Builder { return &Builder{} }

func (b *Builder) Type() registry.SourceType { return SourceTypeGatewayUDPRoute }

func (b *Builder) Enabled(cfg *config.OperatorConfig) bool {
	return cfg.Sources.GatewayUDPRoute != nil && cfg.Sources.GatewayUDPRoute.Enabled
}
