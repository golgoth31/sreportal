...
import (
	...
	alertmanagerchain "github.com/golgoth31/sreportal/internal/controller/alertmanager/chain"
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(
			...
			handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []ctrl.Request {
				...
				return portalfeatures.AlertmanagerReconcileRequestsForPortal(ctx, r.Client, portal)
			}),
			builder.WithPredicates(portalfeatures.PortalAlertsEnabledWakeupPredicate()),
		).
		Named("alertmanager").
		Complete(r)
}
