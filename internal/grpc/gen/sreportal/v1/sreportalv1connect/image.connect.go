...
const (
	...
	ImageServiceName = "sreportal.v1.ImageService"
)
...
const (
	...
	ImageServiceListImagesProcedure = "/sreportal.v1.ImageService/ListImages"
)

// ImageServiceClient is a client for the sreportal.v1.ImageService service.
type ImageServiceClient interface {
	ListImages(context.Context, *connect.Request[v1.ListImagesRequest]) (*connect.Response[v1.ListImagesResponse], error)
}

// NewImageServiceClient constructs a client for the sreportal.v1.ImageService service. By default,
...
func NewImageServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ImageServiceClient {
	...
	imageServiceMethods := v1.File_sreportal_v1_image_proto.Services().ByName("ImageService").Methods()
...
// ListImages calls sreportal.v1.ImageService.ListImages.
...
// ImageServiceHandler is an implementation of the sreportal.v1.ImageService service.
...
func NewImageServiceHandler(svc ImageServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sreportal.v1.ImageService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedImageServiceHandler) ListImages(context.Context, *connect.Request[v1.ListImagesRequest]) (*connect.Response[v1.ListImagesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sreportal.v1.ImageService.ListImages is not implemented"))
}
