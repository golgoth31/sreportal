...
type NetpolEdge struct {
	...
	Evaluated     bool `protobuf:"varint,5,opt,name=evaluated,proto3" json:"evaluated,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetpolEdge) GetEvaluated() bool {
	if x != nil {
		return x.Evaluated
	}
	return false
...
const file_sreportal_v1_netpol_proto_rawDesc = "" +
	...
	"\x05group\x18\x05 \x01(\tR\x05group\"\x7f\n" +
	"\n" +
	"NetpolEdge\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\x12\x0e\n" +
	"\x02to\x18\x02 \x01(\tR\x02to\x12\x1b\n" +
	"\tedge_type\x18\x03 \x01(\tR\bedgeType\x12\x12\n" +
	"\x04used\x18\x04 \x01(\bR\x04used\x12\x1c\n" +
	"\tevaluated\x18\x05 \x01(\bR\tevaluated2\x82\x01\n" +
