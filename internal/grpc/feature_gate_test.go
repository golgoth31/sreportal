...
func TestIsFeatureEnabled(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			checker:    svcgrpc.CheckDNS,
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", true, true, true, true, true)},
			want:       true,
		},
		{
			name:       "DNS disabled",
			portalName: "my-portal",
			checker:    svcgrpc.CheckDNS,
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", false, true, true, true, true)},
			want:       false,
		},
		{
			...
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", true, true, true, false, true)},
			want:       false,
		},
		{
			...
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", true, true, false, true, true)},
			want:       false,
		},
		{
			...
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", true, false, true, true, true)},
			want:       false,
		},
		{
			...
			portals:    []domainportal.PortalView{portalWithFeatures("my-portal", true, true, true, true, false)},
			want:       false,
		},
	}
