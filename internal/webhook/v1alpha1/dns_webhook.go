...
// +kubebuilder:webhook:path=/mutate-sreportal-io-v1alpha1-dns,mutating=true,failurePolicy=fail,sideEffects=None,groups=sreportal.io,resources=dns,verbs=create;update,versions=v1alpha1,name=mdns-v1alpha1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sreportal-io-v1alpha1-dns,mutating=false,failurePolicy=fail,sideEffects=None,groups=sreportal.io,resources=dns,verbs=create;update,versions=v1alpha1,name=vdns-v1alpha1.kb.io,admissionReviewVersions=v1
